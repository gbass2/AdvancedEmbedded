...
unsigned int xMedian = 490;       // Holds the 0 point on the x axis.
unsigned int yMedian = 490;       // Holds the 0 point on the x axis.
...
//    int scaled = abs((((adcValue - rawMin)) / (rawMax - rawMin) * (scaledMax - scaledMin)) + scaledMin);
